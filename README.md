# Terraform Cloud Simple Example

A simple example of a Terraform root module to test VCS integration with Terraform Cloud. This is initially based on the Terraform Getting Started Example Code.
